...
import net.kumasi.debtmonkey.mock.UserAccountEntityMock;
...
/**
 * JUnit test case for UserAccount persistence service
 * 
...
public class UserAccountPersistenceTest 
{
	...
	public void test1() {
		...
		UserAccountPersistence service = PersistenceServiceProvider.getService(UserAccountPersistence.class);
	...
	public void test2() {
		...
		System.out.println("Test UserAccount persistence : delete + load ..." );
		
		UserAccountPersistence service = PersistenceServiceProvider.getService(UserAccountPersistence.class);
		
		UserAccountEntityMock mock = new UserAccountEntityMock();
	...
	private void process(UserAccountPersistence service, UserAccountEntityMock mock, Integer id ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		UserAccountEntity entity = service.load( id );
		if ( entity != null ) {
			// Found 
