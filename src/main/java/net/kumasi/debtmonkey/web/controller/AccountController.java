...
public class AccountController extends AbstractController {
	...
	//--------------------------------------------------------------------------------------
	/**
	 * Populates the combo-box "items" for the referenced entity "AccountAddress"
	 * @param model
	 */
	private void populateListOfAccountAddressItems(Model model) {
		...
		model.addAttribute("listOfAccountAddressItems", items ) ;
	}
	...
	private void populateModel(Model model, Account account, FormMode formMode) {
		...
		if ( formMode == FormMode.CREATE ) {
			...
			populateListOfAccountAddressItems(model);
