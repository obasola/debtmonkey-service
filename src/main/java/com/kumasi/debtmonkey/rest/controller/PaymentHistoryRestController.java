...
import com.kumasi.debtmonkey.web.listitem.PaymentHistoryListItem;
...
public class PaymentHistoryRestController {
    ...
    @RequestMapping(value = "/scheduleHistories/{accountId}",
            method = RequestMethod.GET,
            produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public List<PaymentHistory> findAllByAccount(@PathVariable("accountId") Integer id) {
        return paymentHistoryService.findAllByAccountId(id);
    }
