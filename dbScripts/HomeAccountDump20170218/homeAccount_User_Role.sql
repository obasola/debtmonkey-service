...
CREATE TABLE `User_Role` (
  ...
  PRIMARY KEY (`User_Account_id`,`Role_role_id`),
  KEY `fk_User_Role_Role1` (`Role_role_id`),
  KEY `fk_User_Role_User_Account1_idx` (`User_Account_id`),
  CONSTRAINT `fk_User_Role_Role1` FOREIGN KEY (`Role_role_id`) REFERENCES `Role` (`role_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_User_Role_User_Account1` FOREIGN KEY (`User_Account_id`) REFERENCES `User_Account` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
